...
export default function ActiveQuestList({
    ...
    return (
        <>
            ...
            <div className="pt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                {/* Check if there are any active quests */}
                    ...
                    activeQuests.map(quest => (   
                        <Card key={quest._id} className="p-4">
                            <div className="flex flex-col items-between justify-between h-full">
                                ...
                                <p className="flex grow my-4 text-sm h-fit">{quest.body}</p>
                                ...
                                <div className="flex flex-col text-sm space-y-2">
                                    ...
                                    {quest.gpReward !== 0 && (
                                        <div className="flex justify-between items-center text-xs">
                                            ...
                                            <span className="text-right w-full">{quest.gpReward}</span>
                                        </div>
                                    )}
                                    ...
                                    {quest.invReward !== '' && (
                                        <div className="flex justify-between items-start gap-2 text-xs">
                                            ...
                                            <span className="text-right w-full">{quest.invReward}</span>
                                        </div>
                                    )}
                                </div>
