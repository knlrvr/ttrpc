...
export default function QuestList({
    ...
    return (
        <>
            <span className="text-neutral-500 text-xs">Quests &mdash;</span>
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mt-2 mb-4">
                {quests?.map((quest) => (
                    <div key={quest._id} className="bg-[#222] rounded-lg flex flex-col justify-between p-4 shadow-md min-h-72">
